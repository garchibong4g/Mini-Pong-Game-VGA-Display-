module Pong_Top
  ...
  (input            i_Clk,
   ...
   output reg       o_HSync,
   output reg       o_VSync,
   output [c_VIDEO_WIDTH-1:0] o_Red_Video,
   output [c_VIDEO_WIDTH-1:0] o_Grn_Video,
   output [c_VIDEO_WIDTH-1:0] o_Blu_Video);
  ...
  assign o_Red_Video = w_Draw_Any ? {c_VIDEO_WIDTH{1'b1}} : {c_VIDEO_WIDTH{1'b0}};
  assign o_Grn_Video = w_Draw_Any ? {c_VIDEO_WIDTH{1'b1}} : {c_VIDEO_WIDTH{1'b0}};
  assign o_Blu_Video = w_Draw_Any ? {c_VIDEO_WIDTH{1'b1}} : {c_VIDEO_WIDTH{1'b0}};
